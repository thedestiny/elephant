...
public class QuartzTaskLogController {
    ...
    public LayerData<QuartzTaskLog> list(@RequestParam(value = "page",defaultValue = "1")Integer page,
        ...
        IPage<QuartzTaskLog> iPage = new Page<QuartzTaskLog>(page,limit);
        IPage<QuartzTaskLog> pageData = quartzTaskLogService.page(iPage,wrapper);
