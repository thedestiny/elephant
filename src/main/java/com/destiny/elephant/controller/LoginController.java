...
import com.destiny.elephant.base.MySysUser;
import com.destiny.elephant.entity.Menu;
import com.destiny.elephant.entity.User;
import com.destiny.elephant.util.CaptchaUtil;
...
public class LoginController extends BaseController {
    ...
    public void genCaptcha(HttpServletRequest request, HttpServletResponse response) throws IOException {
        CaptchaUtil.generate(response, request);
    }
    ...
    public String main(Model model) {
        ...
        List<Menu> showMenus = new ArrayList<>();
        ...
        showMenus.sort(Comparator.comparing(Menu::getSort));
        /*showMenus.stream().sorted(new Comparator<Menu>() {
            @Override
        ...
        // showMenus.forEach(System.out::println);
...
/*
class MenuComparator implements Comparator<com.destiny.elephant.entity.Menu> {

    @Override
    public int compare(com.destiny.elephant.entity.Menu o1, com.destiny.elephant.entity.Menu o2) {
        if (o1.getSort() > o2.getSort()) {
            return -1;
        } else {
            return 0;
