...
import com.destiny.elephant.base.BlogHandlerInterceptor;
import com.destiny.elephant.base.ElephantHandlerInterceptor;
...
public class WebMvcConfigurer extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new ElephantHandlerInterceptor())
                .addPathPatterns("/**")
