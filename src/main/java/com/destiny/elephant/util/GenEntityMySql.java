...
//         gc.setControllerName("%s");
     ...
     /*   dsc.setTypeConvert(new MySqlTypeConvert() {
            ...
            public DbColumnType processTypeConvert(String fieldType) {
                ...
                return super.processTypeConvert(new GlobalConfig(), fieldType);
        ...
        dsc.setUsername("");
        dsc.setPassword("");
        dsc.setUrl("jdbc:mysql://server.destiny.com:5306/elephant?useUnicode=true&characterEncoding=UTF-8");
...
//        strategy.setExclude(new String[]{"sys_user_role","sys_role_menu","sys_group_ur"}); // 排除生成的表
        // 自定义实体父类
        strategy.setSuperEntityClass("com.destiny.elephant.base.DataEntity");
        // 自定义实体，公共字段
...
//        strategy.setSuperEntityColumns(new String[] { "id" });
        ...
        pc.setParent("com.destiny");
        pc.setModuleName("elephant");
        pc.setMapper("mapper");
