package com.destiny.elephant.aspect;
...
import com.destiny.elephant.exception.GlobalExceptionHandler;
...
public class WebLogAspect {
     ...
     * 加有注解的@SysLog被拦截
     */
    @Pointcut("@annotation(com.destiny.elephant.annotation.ElephantLog)")
    public void webLog() {
    }
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        ElephantLog mylog = method.getAnnotation(ElephantLog.class);
        if (mylog != null) {
            // 注解上的描述
