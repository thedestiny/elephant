...
<#include "../../../base/global.ftl">
    ...
    <link rel="stylesheet" href="${base}/static/css/user.css?t=${version}" media="all"/>
</head>
...
<form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" class="layui-textarea myself"
                          name="remarks">${userinfo.remarks}</textarea>
            </div>
        </div>
    </div>
    <div class="user_right">
        ...
        <img <#if (userinfo.icon??)>src="${userinfo.icon}" <#else> src="${base}/static/images/face.jpg " </#if>
