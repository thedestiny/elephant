...
<head>
    ...
    <link rel="shortcut icon" href="${base}/static/favicon.ico?t=${version}">
    <link rel="stylesheet" href="${base}/static/layui/css/layui.css?t=${version}" media="all" />
    <link rel="stylesheet" href="//at.alicdn.com/t/font_tnyc012u2rlwstt9.css?t=${version}" media="all" />
    <link rel="stylesheet" href="${base}/static/css/main.css?t=${version}" media="all" />
</head>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-footer footer">
        <p> DESTINY <a href="#" target="_blank">苏ICP备17063650号 </a></p>
    </div>
</div>
<script>
    var baseUrl = "${base}";
...
<script type="text/javascript" src="${base}/static/layui/layui.js?t=${version}"></script>
<script type="text/javascript" src="${base}/static/js/leftNav.js?t=${version}"></script>
<script type="text/javascript" src="${base}/static/js/index.js?t=${version}"></script>
</body>
</html>